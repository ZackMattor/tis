...
QT_MOC_LITERAL(7, 55, 6)
    ...
    "Database\0writeToConsole\0\0str\0init\0"
    "updatePlayer\0Player*\0player\0"
};
...
void Database::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->updatePlayer((*reinterpret_cast< Player*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Database::writeToConsole)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Database::writeToConsole(const QString & _t1)
{
