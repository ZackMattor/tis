...
QT_MOC_LITERAL(10, 95, 17)
    ...
    "GameEngine\0updatePacketReady\0\0Packet\0"
    "packet\0initialize\0addPacket\0queueAddPlayer\0"
    "Player*\0player\0queueRemovePlayer\0"
};
...
void GameEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->updatePacketReady((*reinterpret_cast< Packet(*)>(_a[1]))); break;
        case 1: _t->initialize(); break;
        case 2: _t->addPacket((*reinterpret_cast< Packet(*)>(_a[1]))); break;
        case 3: _t->queueAddPlayer((*reinterpret_cast< Player*(*)>(_a[1]))); break;
        case 4: _t->queueRemovePlayer((*reinterpret_cast< Player*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (GameEngine::*_t)(Packet );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameEngine::updatePacketReady)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void GameEngine::updatePacketReady(Packet _t1)
{
